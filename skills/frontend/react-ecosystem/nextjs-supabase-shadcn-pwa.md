# Nextjs Supabase Shadcn Pwa Coding Standards
...
# Antigravity Rules for Project Context Management

By [@kryptobaseddev](https://github.com/kryptobaseddev)

## Overview

This repository contains a comprehensive `.GEMINI.md` file designed to enhance project management and development workflows when working with Antigravity AI Agent. The rules are specifically crafted to maintain consistent project context and break down development tasks into manageable, trackable units.
...
4. **Best Practices**:
   - Create separate Antigravity Agent chats for each build note
...
The `.GEMINI.md` file can be customized to match your project's specific needs:
...
1. Copy the `.GEMINI.md` file to your project
...
`🔄 **Context:** [Agent: Current] | [Skill: nextjs-supabase-shadcn-pwa] | [Workflow: Current]`
