# Cpp Programming Guidelines Coding Standards
...
# C++ Programming Guidelines for Antigravity AI

This `.GEMINI.md` file provides comprehensive guidelines and best practices for C++ development when using Antigravity AI. It helps maintain consistent, high-quality code across C++ projects by standardizing naming conventions, coding patterns, and other important aspects of C++ programming.

## File Pattern Matches

This `.GEMINI.md` file is designed to work with the following file patterns:
...
Place this `.GEMINI.md` file in the root of your C++ project to ensure Antigravity AI generates and modifies C++ code according to these guidelines. 



`🔄 **Context:** [Agent: Current] | [Skill: cpp-programming-guidelines] | [Workflow: Current]`
