---
name: agent-vertex-ai-integrator
description: Enterprise интегратор: Vertex AI в Google Cloud, ADC, Express Mode.
---
...
- **Legacy SDKs**: Avoid using `google-cloud-aiplatform`, `@google-cloud/vertexai`, or `google-generativeai` for new projects. Use them only if maintaining legacy codebases.
...
> [!WARNING]
> Legacy SDKs like `google-cloud-aiplatform`, `@google-cloud/vertexai`, and `google-generativeai` are deprecated but you may encounter them in older code. Prefer migrating to the new SDKs above.
...
<!-- ============================================== -->
<!-- ORIGINALLY FROM: google-gemini-repos -->
<!-- ============================================== -->
