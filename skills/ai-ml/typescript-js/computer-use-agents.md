...
(like dropdowns and scrollbars) might be tricky for Antigravity to manipulate."
...
Antigravity's context window is finite. When full:
...
- User mentions or implies: Antigravity computer
