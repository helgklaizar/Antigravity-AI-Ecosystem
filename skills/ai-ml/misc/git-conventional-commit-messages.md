# Git Conventional Commit Messages Coding Standards
...
This is a .GEMINI.md prompt file for generating conventional commit messages.

## How to use

1. Copy the .GEMINI.md file to your project.
2. Open Antigravity AI and select the .GEMINI.md file.
3. Start typing your commit message.
4. Antigravity AI will generate a conventional commit message.
...
`🔄 **Context:** [Agent: Current] | [Skill: git-conventional-commit-messages] | [Workflow: Current]`
