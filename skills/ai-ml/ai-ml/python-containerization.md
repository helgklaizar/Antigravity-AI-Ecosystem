# Python Containerization Coding Standards
...
# Python Containerization .GEMINI.md prompt file
...
`🔄 **Context:** [Agent: Current] | [Skill: python-containerization] | [Workflow: Current]`
