...
1. `.gemini/skills/*/` (skills registradas no Antigravity Code)
...
| registered     | Se esta em .gemini/skills/ (true/false)            |
...
Opcionalmente, para discovery nativo do Antigravity Code:
4. Copiar o SKILL.md para `.gemini/skills/<nome>/SKILL.md`
