...
4. [Antigravity Code Integration](#4-claude-code-integration)
...
## 4. Antigravity Code Integration

How to use the ComfyUI Gateway from within a Antigravity Code session or any
environment where Antigravity has access to shell tools.

### Generating an Image from Antigravity Code

When Antigravity Code has access to `bash` or `curl`, you can generate images directly:
...
### Using Base64 Output in Antigravity Code
