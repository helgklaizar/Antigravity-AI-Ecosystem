---
name: skill-check
description: "Validate Antigravity Code skills against the agentskills specification. Catches structural, semantic, and naming issues before users do."
...
```
User: check my skill at ~/.gemini/skills/weekly-report/SKILL.md
...
```
User: skillcheck ~/.gemini/skills/processing-pdfs/SKILL.md
