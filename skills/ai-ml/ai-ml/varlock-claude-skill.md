...
description: "Secure environment variable management ensuring secrets are never exposed in Antigravity sessions, terminals, logs, or git commits"
risk: safe
source: "https://github.com/wrsmith108/varlock-claude-skill"
date_added: "2026-02-27"
---

# Varlock Antigravity Skill

## Overview

Secure environment variable management ensuring secrets are never exposed in Antigravity sessions, terminals, logs, or git commits
