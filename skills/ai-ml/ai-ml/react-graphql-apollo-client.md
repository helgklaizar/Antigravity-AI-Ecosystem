# React Graphql Apollo Client Coding Standards

This skill provides language, framework, and tooling rules.

// React + GraphQL (Apollo Client) .GEMINI.md
...
`🔄 **Context:** [Agent: Current] | [Skill: react-graphql-apollo-client] | [Workflow: Current]`
