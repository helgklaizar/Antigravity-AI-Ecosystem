...
- Use when you want to reduce input token costs across Antigravity Code sessions
...
- Dashboard requires Node.js 18+ and reads session data from `~/.gemini/projects/`
