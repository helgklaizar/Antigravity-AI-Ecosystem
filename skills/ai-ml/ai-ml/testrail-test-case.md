# Testrail Test Case Coding Standards
...
A specialized .GEMINI.md prompt for creating standardized TestRail test cases with clear steps, expected results, and test data for efficient test management and execution.
...
The .GEMINI.md prompt guides users in creating effective TestRail test cases with these key elements:
...
`🔄 **Context:** [Agent: Current] | [Skill: testrail-test-case] | [Workflow: Current]`
