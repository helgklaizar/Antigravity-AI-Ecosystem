# Qwik Tailwind Coding Standards

This skill provides language, framework, and tooling rules.

// Qwik.js with Tailwind CSS (TypeScript and Vite included) .GEMINI.md
...
`🔄 **Context:** [Agent: Current] | [Skill: qwik-tailwind] | [Workflow: Current]`
