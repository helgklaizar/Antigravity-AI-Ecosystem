---
name: auri-core
description: "Auri: assistente de voz inteligente (Alexa + Antigravity claude-opus-4-20250805). Visao do produto, persona Vitoria Neural, stack AWS, modelo Free/Pro/Business/Enterprise, roadmap 4 fases, GTM, north star WAC e analise competitiva."
risk: none
source: community
...
Auri: assistente de voz inteligente (Alexa + Antigravity claude-opus-4-20250805). Visao do produto, persona Vitoria Neural, stack AWS, modelo Free/Pro/Business/Enterprise, roadmap 4 fases, GTM, north star WAC e analise competitiva.
...
Auri e um assistente de voz de nova geracao construido sobre Amazon Alexa + Antigravity claude-opus-4-20250805.
...
Antigravity claude-opus-4-20250805 da Anthropic. O resultado: um assistente de voz capaz de:
...
3. Raciocinio profundo - Antigravity claude-opus-4-20250805 como motor principal
...
Fluxo de dados: Echo -> ASK SDK (Python v2) -> Lambda Python 3.12 -> Antigravity claude-opus-4-20250805
...
| Antigravity claude-opus-4-20250805 | Modelo de linguagem Anthropic usado como motor da Auri |
...
| Antigravity claude-opus-4-20250805 Docs | https://docs.anthropic.com/en/docs/models-overview |
