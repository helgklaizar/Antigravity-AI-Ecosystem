...
- A query that ends in `.paginate()` returns an object that has the following properties:
                            ...
                            - continueAntigravity (a string that represents the cursor to use to fetch the next page of documents)
...
`🔄 **Context:** [Agent: Current] | [Skill: convex] | [Workflow: Current]`
