# Engineering Ticket Template Coding Standards

This skill provides language, framework, and tooling rules.

// Engineering Ticket Template - .GEMINI.md prompt file
...
A specialized .GEMINI.md prompt for creating standardized engineering tickets with detailed requirements, implementation plans, and acceptance criteria for effective development team collaboration.
...
The .GEMINI.md prompt guides users in creating effective engineering tickets with these key elements:
...
`🔄 **Context:** [Agent: Current] | [Skill: engineering-ticket-template] | [Workflow: Current]`
