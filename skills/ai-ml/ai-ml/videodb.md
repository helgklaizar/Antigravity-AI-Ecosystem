...
- [reference/api-reference.md](../backend/api-reference.md) - Complete VideoDB Python SDK API reference
- [reference/search.md](../ai-ml/search.md) - In-depth guide to video search (spoken word and scene-based)
- [reference/editor.md](../design-ui/editor.md) - Timeline editing, assets, and composition
- [reference/streaming.md](../ai-ml/streaming.md) - HLS streaming and instant playback
- [reference/generative.md](../ai-ml/generative.md) - AI-powered media generation (images, video, audio)
- [reference/rtstream.md](../mobile/rtstream.md) - Live stream ingestion workflow (RTSP/RTMP)
- [reference/rtstream-reference.md](../ai-ml/rtstream-reference.md) - RTStream SDK methods and AI pipelines
- [reference/capture.md](../automation-tools/capture.md) - Desktop capture workflow
- [reference/capture-reference.md](../automation-tools/capture-reference.md) - Capture SDK and WebSocket events
- [reference/use-cases.md](../backend/use-cases.md) - Common video processing patterns and examples
...
For complete capture workflow, see [reference/capture.md](../automation-tools/capture.md).
