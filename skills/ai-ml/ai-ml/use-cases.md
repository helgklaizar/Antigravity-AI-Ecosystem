...
Common workflows and what VideoDB enables. For code details, see [api-reference.md](api-reference.md), [capture.md](../automation-tools/capture.md), [editor.md](../design-ui/editor.md), and [search.md](../ai-ml/search.md).
