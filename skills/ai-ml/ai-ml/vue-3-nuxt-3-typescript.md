# Vue 3 Nuxt 3 Typescript Coding Standards

This skill provides language, framework, and tooling rules.



# Vue 3 Nuxt 3 TypeScript .GEMINI.md prompt file
