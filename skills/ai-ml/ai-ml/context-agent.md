...
Continuidade perfeita entre sessões do Antigravity Code. Captura, comprime e
...
│   ├── session_parser.py       # Parser JSONL do Antigravity Code
...
Como o MEMORY.md é incluído no system prompt de toda sessão, o Antigravity
