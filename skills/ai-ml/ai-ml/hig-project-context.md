...
Create and maintain `.gemini/apple-design-context.md` so other HIG skills can skip redundant questions.
...
Generate `.gemini/apple-design-context.md` using this structure:
...
1. Read the current `.gemini/apple-design-context.md`
