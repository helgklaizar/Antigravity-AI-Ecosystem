# Kotlin Ktor Development Coding Standards

This skill provides language, framework, and tooling rules.

## Instruction to developer: save this file as .GEMINI.md and place it on the root project directory
...
`🔄 **Context:** [Agent: Current] | [Skill: kotlin-ktor-development] | [Workflow: Current]`
