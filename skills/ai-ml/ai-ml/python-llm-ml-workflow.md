# Python Llm Ml Workflow Coding Standards
...
# Python LLM & ML Workflow .GEMINI.md Prompt File
## Synopsis
...
- Tailored for use with the Antigravity IDE, but applicable to general Python development.

## Usage

Place this `.GEMINI.md` file in the root of your project to guide the AI assistant in adhering to these standards and practices.
...
`🔄 **Context:** [Agent: Current] | [Skill: python-llm-ml-workflow] | [Workflow: Current]`
