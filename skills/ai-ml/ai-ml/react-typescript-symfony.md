# React Typescript Symfony Coding Standards
...
# React TypeScript Symfony .GEMINI.md prompt file
...
`🔄 **Context:** [Agent: Current] | [Skill: react-typescript-symfony] | [Workflow: Current]`
