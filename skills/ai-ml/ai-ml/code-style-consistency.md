# Code Style Consistency Coding Standards

This skill provides language, framework, and tooling rules.

// Code Style Consistency - .GEMINI.md prompt file
...
A specialized .GEMINI.md prompt for analyzing codebase patterns and ensuring new AI-generated code follows the established style and conventions of the project.
...
The .GEMINI.md prompt guides developers in maintaining code style consistency with these key elements:
...
`🔄 **Context:** [Agent: Current] | [Skill: code-style-consistency] | [Workflow: Current]`
