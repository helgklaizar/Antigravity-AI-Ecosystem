# Project Epic Template Coding Standards

This skill provides language, framework, and tooling rules.

// Project Epic Template - .GEMINI.md prompt file
...
A specialized .GEMINI.md prompt for creating comprehensive project epics and user stories that align with agile methodologies and provide clear direction for development teams.
...
The .GEMINI.md prompt guides users in creating effective project documentation with these key elements:
...
`🔄 **Context:** [Agent: Current] | [Skill: project-epic-template] | [Workflow: Current]`
