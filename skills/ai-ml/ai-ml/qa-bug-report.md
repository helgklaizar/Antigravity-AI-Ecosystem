# Qa Bug Report Coding Standards

This skill provides language, framework, and tooling rules.

// QA Bug Report - .GEMINI.md prompt file
...
A specialized .GEMINI.md prompt for creating standardized bug reports with clear reproduction steps and detailed environmental context for efficient bug resolution.
...
The .GEMINI.md prompt guides users in creating effective bug reports with these key elements:
...
`🔄 **Context:** [Agent: Current] | [Skill: qa-bug-report] | [Workflow: Current]`
