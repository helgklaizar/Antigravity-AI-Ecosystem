# React Native Expo Router Typescript Windows Coding Standards

This skill provides language, framework, and tooling rules.

// React Native Expo .GEMINI.md
...
`🔄 **Context:** [Agent: Current] | [Skill: react-native-expo-router-typescript-windows] | [Workflow: Current]`
