# Cypress Integration Testing Coding Standards
...
A specialized .GEMINI.md prompt for creating comprehensive integration tests using Cypress with TypeScript support.
...
The .GEMINI.md prompt guides QA engineers in creating effective integration tests using Cypress with these key elements:
...
`🔄 **Context:** [Agent: Current] | [Skill: cypress-integration-testing] | [Workflow: Current]`
