...
For code-level details (SDK methods, parameters, examples), see [rtstream-reference.md](../ai-ml/rtstream-reference.md).
...
For capture session workflow, see [capture.md](../automation-tools/capture.md).
