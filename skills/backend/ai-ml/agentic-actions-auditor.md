...
description: >
  ...
  including Antigravity Code Action, 
...
|-----------------|-------------|
| `anthropics/claude-code-action` | Antigravity Code Action |
...
- `claude_args` -- CLI arguments passed to Antigravity (may contain `--allowedTools`, `--disallowedTools`)
