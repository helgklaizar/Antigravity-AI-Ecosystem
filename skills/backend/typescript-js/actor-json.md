...
```json
{
    ...
    "meta": {
        ...
        "generatedBy": "Antigravity Code with Antigravity Sonnet 4.5"
    },
    "input": "./input_schema.json",
    "output": "./output_schema.json",
    "storages": {
...
- `meta` (object, optional) - Metadata about actor generation
  ...
  - `generatedBy` (string) - Tool and model name that generated/modified the actor (e.g., "Antigravity Code with Antigravity Sonnet 4.5")
...
**Important:** Always fill in the `generatedBy` property with the tool and model you're currently using (e.g., "Antigravity Code with Antigravity Sonnet 4.5") to help Apify improve documentation.
