# Xian Smart Contracts Coding Standards

This skill provides language, framework, and tooling rules.

# Xian Smart Contract Development - Antigravity Rules
...
## About This Antigravity Rules File

This `.GEMINI.md` file provides guidance to Antigravity AI when developing Xian smart contracts, ensuring best practices are followed for contract structure, state management, event handling, and testing.




`🔄 **Context:** [Agent: Current] | [Skill: xian-smart-contracts] | [Workflow: Current]`
