...
4. СРАЗУ (до первого коммита) создай файл `GEMINI.md` в корне, строго используя новый индексный шаблон `.ai/templates/gemini-index.md`. Заполни стек, архитектуру, красные флаги и пути к документации. Не храни задачи словесно в GEMINI.md, только путь на файл-спринт.
